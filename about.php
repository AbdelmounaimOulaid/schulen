...
<head>
    ...
    <title>Schulen Institute - About</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-12">
                        <h1 class="mb-0">About Schulen Institute</h1>
