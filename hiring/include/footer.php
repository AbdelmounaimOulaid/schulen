<!-- <footer class="kilimanjaro_area">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="kilimanjaro_part">
                        <div class="footer-logo">
                            <img src="assets/img/logo_schulen_white.png" alt="logo">
                        </div>
                        <p style="font-weight:bold;font-size:20px">Schulen is much more than a private for-profit academy! We are a social movement!</p>
                    </div>
                    <div class="footer__social">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="https://www.instagram.com/Schuleninstitute.academy/"><i class="fa-brands fa-instagram"></i></a></li>

                                            <li><a href="https://www.linkedin.com/company/Schuleninstitute-academy-2019/?lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_companies%3BvjFNKORbSuqfgqaYpuHgQg%3D%3D"><i class="fa-brands fa-linkedin-in"></i></a></li>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="kilimanjaro_part m-top-15">
                        <h5>Contact Us</h5>
                        <ul class="kilimanjaro_links">
                            <li><a href="mailto:contact@Schuleninstitute.us"><i class="far fa-envelope"></i> contact@Schuleninstitute.com</a></li>
    ...
    <!-- <div class=" kilimanjaro_bottom_header_one section_padding_50 text-center">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p style="font-size: 14px;">Copyright© 2019-2022 Schuleninstitute Academy 1617 Monroe St NE Washington, DC 20018 All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="footer__widget footer__widget-2 mb-50">
                                ...
                                <div class="logo">
                                    ...
                                    <a href="../../index.php">
                                        ...
                                        <img src="../../assets/img/logo_schulen_white.png" alt="">
                                ...
                                <div class="footer__widget-info">
                                    ...
                                    <p style="font-weight:bold;font-size:20px">Schulen is much more than a private for-profit institute! We are a social movement!</p>
                                    ...
                                    <div class="footer__social">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="https://www.instagram.com/schulen.institute/"><i class="fa-brands fa-instagram"></i></a></li>

                                            <li><a href="https://schulenltd.com/404"><i class="fa-brands fa-linkedin-in"></i></a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-12">
                                ...
                                <div class="footer__copyright text-left">
                                  ...
                                  <p> Copyright© 2020-2023 Schulen Institute kreuzstrasse 24, 8008 Zürich, Switzerland All Rights Reserved.
                                </div>
